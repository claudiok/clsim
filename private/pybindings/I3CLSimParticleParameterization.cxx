...
{
    {
        ...
        .def(init<I3CLSimParticleToStepConverterPtr, const I3Particle &, double, double, bool>
             (
              (
               bp::arg("converter"),
               bp::arg("forParticleType"),
...
#else
        .def_readwrite("forPdgEncoding", &I3CLSimParticleParameterization::forPdgEncoding)
#endif
