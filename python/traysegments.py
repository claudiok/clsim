...
def genDefaultParameterizationList(theConverter):
    fromEnergy=0.
    toEnergy=float('Inf')
...
def I3CLSimMakeHits(tray, name,
    ...
    Reads its particles from an I3MCTree and writes
    ...
    particleParameterizations = clsim.genDefaultParameterizationList(cascadeConverter)
